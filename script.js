  ...
  // ============================================================
  // PLAY AGAIN — from the final Count page, jump back to the very
  // first page (the countdown) without refreshing. Since the
  // countdown has already arrived by the time she's reached the
  // end, she'll land straight on the "Lali" + Begin moment rather
  // than watching the clock tick again.
  // ============================================================
